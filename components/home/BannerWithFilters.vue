<template>
  <div class="relative bg-gray-900 text-white">
    ...
    <div class="absolute inset-0 overflow-hidden">
      <img src="https://images.unsplash.com/photo-1593696140826-c58b021acf8b?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Real Estate Background" class="w-full h-full object-cover object-center" />
      <div class="absolute inset-0 bg-black bg-opacity-60"></div>
    </div>

    <!-- Hero Content -->
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-center mb-8">
            ...
            <div class="md:col-span-2">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                <label v-for="feature in propertyFeatures" :key="feature" class="inline-flex items-center">
                  <input type="checkbox" v-model="advancedFilters.features" :value="feature" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
            ...
            <div class="md:col-span-2">
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-2">
                <label v-for="amenity in amenities" :key="amenity" class="inline-flex items-center">
                  <input type="checkbox" v-model="advancedFilters.amenities" :value="amenity" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" />
