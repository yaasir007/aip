	...
	<footer class="bg-white">
		<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
			<div class="flex flex-col items-center gap-4 rounded-lg bg-[#036E5C] p-6 shadow-lg sm:flex-row sm:justify-between">
				<strong class="text-xl text-white sm:text-xl"> Chat with us! </strong>
					...
					<li>
						<a href="https://www.tiktok.com" rel="noreferrer" target="_blank" class="text-teal-700 transition hover:text-teal-700/75">
							...
							<svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
								<path
									d="M9.067 8.578v4.57a3.054 3.054 0 1 1-2.03-2.886V8.384a4.853 4.853 0 1 0 3.945 4.762h-.004V2.75h1.756c.22 2.172 1.873 3.907 4.042 4.17v1.786c-1.175.007-2.302-.29-3.29-.845v4.428l-.003.023a6.61 6.61 0 1 1-4.42-5.734z"
								/>
							</svg>
						</a>
					</li>
