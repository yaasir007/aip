		...
		<div class="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
				...
				<form @submit.prevent="handleSubmit" class="space-y-4">
					...
					<div class="flex items-center">
						...
						<label for="terms" class="ml-2 block text-sm text-gray-700">
							I agree to the <a @click="goToTermsAndConditions" class="text-[#025a4a] hover:underline">Terms and Conditions</a>
						</label>
					</div>
			...
			<div class="px-8 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-center">
				<p class="text-sm text-gray-600">
					...
					<a @click="goToLogin" class="font-medium text-[#025a4a] hover:underline cursor-pointer">Sign in</a>
				</p>
			</div>
		</div>
	</div>
